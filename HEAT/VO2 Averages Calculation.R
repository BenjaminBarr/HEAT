...
vo2.range <- quantile(df$vo2, probs = c(0.70, 0.75,
                                         0.80, 0.85,
                                         0.90, 0.95))
# Fit a LOESS model
...
ggplot(df, aes(x = vo2, y = hr)) +
  ...
  annotate("text", x = 9, y = (vo2.range[1,2] + vo2.range[2,2])/2, hjust = 0,
  ...
  annotate("text", x = 9, y = (vo2.range[3,2] + vo2.range[4,2])/2, hjust = 0,
  ...
  annotate("text", x = 9, y = (vo2.range[5,2] + vo2.range[6,2])/2, hjust = 0, 
